...
Storyfront runs AI agents unattended on your machine, so security issues matter. Please report vulnerabilities privately through GitHub's **Report a vulnerability** (Security tab), not in public issues.

## What Storyfront protects against
...
- **Credentials:** Storyfront never reads, stores or forwards Claude or Codex credentials. Agents run inside your own host session.
