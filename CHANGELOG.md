...
- An MCP server with 32 tools for agents and the lead: tickets, park/resume checkpoints, reviews, questions, escalations, decisions, design docs, memory, per-agent environments, and `mc_wait` for the lead
